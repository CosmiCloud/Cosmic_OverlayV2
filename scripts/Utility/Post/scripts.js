...
module.exports ={
  ...
  stopscripts: async function stop(){
    try{
      var stop = 'cd ./cron-jobs-node && sudo forever stop notification.js && sudo forever stop archive.js && sudo forever stop awsbackup.js && sudo forever stop ping.js && sudo forever stop report.js'
  ...
  restartscripts: async function restart(){
    try{
      var restart = 'cd ./cron-jobs-node && sudo forever restart notification.js && sudo forever restart archive.js && sudo forever restart awsbackup.js && sudo forever restart report.js'
